...
public class HA7SSearchBusCmdTest {
    ...
    public void testNotByAlarmPositive(String[] deviceAddresses) {
        ...
        if (deviceAddresses.length == 0) {
            Answer<HA7S.cmdReturn> answer = HA7STest.makeSearchCmdReturnAnswer(HA7S.cmdResult.Success, null, firstWriteCTM);
            ...
            Answer<HA7S.cmdReturn> answer = HA7STest.makeSearchCmdReturnAnswer(HA7S.cmdResult.Success, addr1, firstWriteCTM);
            when(mockHA7S.cmdSearchROM(any(byte[].class), any(Logger.class))).thenAnswer(answer);

            Answer<HA7S.cmdReturn> answer2 = HA7STest.makeSearchCmdReturnAnswer(HA7S.cmdResult.Success, null, secondWriteCTM);
            ...
            Answer<HA7S.cmdReturn> answer2 = HA7STest.makeSearchCmdReturnAnswer(HA7S.cmdResult.Success, addr2, secondWriteCTM);
            Answer<HA7S.cmdReturn> answer3 = HA7STest.makeSearchCmdReturnAnswer(HA7S.cmdResult.Success, null, secondWriteCTM);
    ...
    public void testByAlarmPositive(String[] deviceAddresses) {
        ...
        if (deviceAddresses.length == 0) {
            ...
            Answer<HA7S.cmdReturn> answer2 = HA7STest.makeSearchCmdReturnAnswer(HA7S.cmdResult.Success, null, secondWriteCTM);
            when(mockHA7S.cmdNextConditionalSearch(any(byte[].class), any(Logger.class))).thenAnswer(answer2);
        }
        else if (deviceAddresses.length == 2) {
            byte[] addr1 = deviceAddresses[0].getBytes();
            Answer<HA7S.cmdReturn> answer = HA7STest.makeSearchCmdReturnAnswer(HA7S.cmdResult.Success, addr1, firstWriteCTM);
    ...
    public void testByFamilyCodePositive(String[] deviceAddresses) {
        ...
        if (deviceAddresses.length == 0) {
            Answer<HA7S.cmdReturn> answer = HA7STest.makeSearchCmdReturnAnswer(HA7S.cmdResult.Success, null, firstWriteCTM);
            when(mockHA7S.cmdFamilySearch(any(byte.class), any(byte[].class), any(Logger.class))).thenAnswer(answer);
        }
        else if (deviceAddresses.length == 1) {
            byte[] addr1 = deviceAddresses[0].getBytes();
            Answer<HA7S.cmdReturn> answer = HA7STest.makeSearchCmdReturnAnswer(HA7S.cmdResult.Success, addr1, firstWriteCTM);
    ...
    public void testSearchNegative(HA7SSerial.ReadResult readResult, byte[] rbuf_data, SearchBusCmd.Result expectedResult) {
        ...
        when(mockSerial.writeReadTilCR(any(byte[].class), any(byte[].class), any(Long.TYPE), any(Logger.class)))
                .thenAnswer(HA7SSerialTest.makeWriteReadTilCRResult(new HA7SSerialTest.TestHA7SSerial(readResult, rbuf_data, 5L)));
    ...
    public Object[][] createNegativeCases() {
        ...
        return new Object[][]{
                {new HA7SSerial.ReadResult(HA7SSerial.ReadResult.ErrorCode.RR_ReadOverrun), null, SearchBusCmd.Result.communication_error},
                {new HA7SSerial.ReadResult(HA7SSerial.ReadResult.ErrorCode.RR_ReadTimeout), null, SearchBusCmd.Result.communication_error},
                {new HA7SSerial.ReadResult(HA7SSerial.ReadResult.ErrorCode.RR_Error), null, SearchBusCmd.Result.communication_error},
                // invalid read count
                {new HA7SSerial.ReadResult(HA7SSerial.ReadResult.ErrorCode.RR_Success, 1, 2L), null, SearchBusCmd.Result.communication_error},
                // invalid address
                {new HA7SSerial.ReadResult(HA7SSerial.ReadResult.ErrorCode.RR_Success, 16, 2L), invalidAddress.getBytes(), SearchBusCmd.Result.communication_error}
        };
    }
