...
public interface WaitForDeviceByAddressCallback {
  ...
  /**
   * This is the notification side of WaitForDeviceByAddress. The notification is done on the Search
   * callback thread under a synchronized lock on the WaitForDeviceByAddress instance.
   *
