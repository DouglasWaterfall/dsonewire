 ...
 * Created by dwaterfa on 7/22/17. <p> <p> public void addBusMaster(BusMaster bm) <p> public
 * synchronized BusMaster[] getBusMasters() public synchronized boolean hasBusMasterByName(String
 * bmName) <p> public class BusMasterAdded <p> public void removeBusMaster(BusMaster bm) <p> public
 * synchronized BusMaster[] getBusMasters() public synchronized boolean hasBusMasterByName(String
 * bmName) <p> public class BusMasterRemoved <p> Add an Observer to the Registry. We will update it
 * with all the known BusMasters. public void addObserver(Observer o) <p> BusMaster
 * waitForDeviceByAddress(String address, long bmSearchPeriodMSec)
 */
...
public class BusMasterRegistryTest {
  ...
  @Test(expectedExceptions = {
      IllegalArgumentException.class}, expectedExceptionsMessageRegExp = "bm does not have a name")
  ...
  public void testAddBusMasterNotifiesIfRegisteredAfter() {
    ...
    Assert.assertEquals(
        ((BusMasterRegistry.BusMasterAdded) arg2.getAllValues().get(0)).getBusMaster(), mockBM);
    ...
    Assert.assertEquals(
        ((BusMasterRegistry.BusMasterAdded) arg2.getAllValues().get(1)).getBusMaster(), mockBM_2);
  }
  ...
  @Test(expectedExceptions = {
      IllegalArgumentException.class}, expectedExceptionsMessageRegExp = "bm not known to the registry")
  ...
  public void testRemoveBusMasterNotifies() {
    ...
    Assert.assertEquals(
        ((BusMasterRegistry.BusMasterRemoved) arg2.getAllValues().get(1)).getBusMaster(), mockBM);
  }
}
