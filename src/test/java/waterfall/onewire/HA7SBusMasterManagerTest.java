...
public class HA7SBusMasterManagerTest {
    ...
    public void testNegativeTests(String ttyArg, Class serialClass, Logger.LogLevel logLevel, Class exceptionClass) {
    ...
    public Object[][] getNegativeTestData() {
        return new Object[][] {
                // ttyArg
                { null, HA7SSerialDummy.class, Logger.LogLevel.CmdOnlyLevel(), IllegalArgumentException.class },
